...
The `methurator_summary.yml` file is generated by the `methurator downsample` command and contains all results and metadata from the analysis in a structured format. You can find an example [here](https://github.com/VIBTOBIlab/methurator/tree/main/tests/data/methurator_summary.yml).
