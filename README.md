...
For reference, the previous approach used arctangent curve fitting:
...
This legacy method is no longer the primary approach but may be found in earlier versions.
